...
namespace Backend.Features.Task.Interfaces
{
    public interface ITaskService
    {
        ...
        Task<InProgressResultDto> GetInProgressAsync(int userId);
        //Task<IEnumerable<TaskDetailsDto>> GetCompletedInIntervalAsync(DateTimeOffset from, DateTimeOffset to);
        ...
        System.Threading.Tasks.Task DisassociateTaskFromProjectAsync(int userId,int taskId, int projectId);
    }
}