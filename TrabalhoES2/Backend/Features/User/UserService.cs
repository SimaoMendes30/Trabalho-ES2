...
public sealed class UserService : IUserService
{
    ...
    public async System.Threading.Tasks.Task<IEnumerable<UserDetailsDto>> GetAllAsync()
    {
        var users = await _repo.GetAllAsync();
        return users.Select(user => _mapper.Map<UserDetailsDto>(user)).ToList();
    }

    public async System.Threading.Tasks.Task UpdateRoleAsync(int id, bool isAdmin, bool isSuperUser)
    {
