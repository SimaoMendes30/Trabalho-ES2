...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=aws-0-eu-west-2.pooler.supabase.com;Port=6543;Database=sgsc;Username=postgres.xmluhjrjpzopiijmwjkz;Password=mNyQwUMNNAFhX5y;MaxPoolSize=100;Timeout=300;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Membro>(entity =>
        {
            ...
            entity.HasOne(d => d.Projeto).WithMany(p => p.Membros)
                .HasForeignKey(d => d.IdProjeto)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Membro_id_projeto_fkey");

            entity.HasOne(d => d.Utilizador).WithMany(p => p.Membros)
        ...
        modelBuilder.Entity<Tarefa>(entity =>
        {
            ...
            entity.HasIndex(e => e.Responsavel, "idx_tarefa_responsavel");
            ...
            entity.HasMany(d => d.Projetos).WithMany(p => p.IdTarefas)
        ...
        modelBuilder.Entity<Utilizador>(entity =>
        {
            ...
            entity.HasMany(d => d.Tarefas).WithMany(p => p.Utilizadores)
                .UsingEntity<Dictionary<string, object>>(
                    "TarefaUtilizador",
